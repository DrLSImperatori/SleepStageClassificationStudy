...
% end
% end
load(['/home/laurai/matlab/Features_CleanCode/REV1/WREM_BStrap_OneIteration_REV2000_Scheme.mat'], 'ShuffLabsPerm', 'Labs')
...
%     toc    
   ...
   %% New Version 
    ...
    [MaxAcc, MaxAccFeat]=max(AccFeats); 
...
save(['/home/laurai/matlab/Results/WREM_BStrap_OneIteration_' num2str(test) '.mat'], 'IncFeat', 'LDAAccuracy', 'CICount', 'Dist', 'PermAll', 'p')
